...
public class Main {
    ...
    public static void main(String[] args) {
        xeNgheAn=DKF.ReadxeMayFromFile("NgheAn.Dat");
        xeBacGiang=DKF.ReadxeMayFromFile("BacGiang.Dat");
    ...
    public static void menu() {
        ...
        System.out.println("7. Xuất tất cả thông tin xe theo mã biển số xe");
        System.out.println();
        System.out.println("====================================================================================");
        System.out.println();
    }
    ...
    public static void LuaChon1() {
       // DKF.OpenFileToWrite("NgheAn.Dat");
        xeMay A = new xeMay();
        boolean check = false;
        do {
            A.Nhap();
            ...
            for (xeMay i : xeNgheAn) {
                if (A.getBienso().compareTo(i.getBienso()) == 0) {
                    System.out.print("Bien so xe da ton tai!");
                    check = true;
                } else if (A.getCMND().compareTo(i.getCMND()) == 0) {
                    System.out.print("CMND da ton tai!");
                    check = true;
                }
            }
        }
    ...
    public static void LuaChon3() {
        ...
        switch (sc.nextInt()) {
            case 1: {
                ...
                System.out.format("      %-20s %-20s %-20s %-20s \n","Biển số", "Loại xe", "Màu xe", "Giá tiền");
                System.out.println();
                for (xeMay i : xeNgheAn) System.out.format("      %-20s %-20s %-20s %-20f \n", i.bienSo, i.loaiXe, i.mauXe, i.giaTien);
            }
            break;
            case 2: {
            ...
            case 1: {
                ...
                for (xeMay i : xeNgheAn) {
                    if (i.getCMND().compareTo(CMT1) == 0) {
                        System.out.format("      %-20s %-20s %-20s %-20f \n", i.bienSo, i.loaiXe, i.mauXe, i.giaTien);
                        System.out.print("Cap nhat thong tin (Y/N): ");
    ...
    public static void LuaChon7() {
        ...
        switch (sc.nextInt()) {
            case 1: {
                System.out.format("      %-15s  %-15s %-15s %-15s %-15s %-15s %-15s %-15s %-15s \n","Tên", "Tuổi", "SĐT", "CMND", "Địa chỉ","Biển số", "Loại xe", "Màu xe", "Giá tiền");
                for (xeMay i : xeNgheAn)
                    System.out.format("      %-15s  %-15s %-15s %-15s %-15s %-15s %-15s %-15s %-15s \n",i.getTen(), i.getTuoi(),i.getSDT(),i.getCMND(),i.getDiachi(), i.bienSo, i.loaiXe, i.mauXe, i.giaTien);
